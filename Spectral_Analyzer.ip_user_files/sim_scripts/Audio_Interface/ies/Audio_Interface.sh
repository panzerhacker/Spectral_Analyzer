...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.Audio_Interface \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Spectral_Analyzer.srcs/sources_1/bd/Audio_Interface/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../Spectral_Analyzer.srcs/sources_1/bd/Audio_Interface/ipshared/e2dd/hdl/verilog" \
       +incdir+"../../../../Spectral_Analyzer.srcs/sources_1/bd/Audio_Interface/ipshared/ec67/hdl" \
       +incdir+"../../../../Spectral_Analyzer.srcs/sources_1/bd/Audio_Interface/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../Spectral_Analyzer.srcs/sources_1/bd/Audio_Interface/ipshared/1313/hdl" \
       +incdir+"../../../../Spectral_Analyzer.srcs/sources_1/bd/Audio_Interface/ipshared/e2dd/hdl/verilog" \
