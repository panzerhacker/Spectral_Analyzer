...
HD_PWD='C:/Users/panze/Documents/Project/Vivado_Work/Spectral_Analyzer/Spectral_Analyzer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Interface_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Audio_Interface_wrapper.tcl -notrace
