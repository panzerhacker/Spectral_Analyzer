...
HD_PWD='C:/Users/panze/Documents/Project/Vivado_Work/Spectral_Analyzer/Spectral_Analyzer.runs/Audio_Interface_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Audio_Interface_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Audio_Interface_xbar_2.tcl
