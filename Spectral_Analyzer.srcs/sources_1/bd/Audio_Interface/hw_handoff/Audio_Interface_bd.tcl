...
################################################################
# This is a generated script based on design: Audio_Interface
#
...
# source Audio_Interface_script.tcl
...
set design_name Audio_Interface
...
proc create_root_design { parentCell } {
  ...
  set GPIO_AUDIO [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 GPIO_AUDIO ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Empty_Threshold_Assert_Value_rach {254} \
   CONFIG.Empty_Threshold_Assert_Value_rdch {254} \
   CONFIG.Empty_Threshold_Assert_Value_wach {254} \
   CONFIG.Empty_Threshold_Assert_Value_wdch {254} \
   ...
   CONFIG.Full_Threshold_Assert_Value_rach {255} \
   CONFIG.Full_Threshold_Assert_Value_rdch {255} \
   CONFIG.Full_Threshold_Assert_Value_wach {255} \
   CONFIG.Full_Threshold_Assert_Value_wdch {255} \
   CONFIG.Full_Threshold_Assert_Value_wrch {15} \
   CONFIG.INTERFACE_TYPE {AXI_MEMORY_MAPPED} \
   CONFIG.Input_Depth_rach {256} \
   CONFIG.Input_Depth_rdch {256} \
   CONFIG.Input_Depth_wach {256} \
   CONFIG.Input_Depth_wdch {256} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports GPIO_AUDIO] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXI [get_bd_intf_pins fifo_generator_0/M_AXI] [get_bd_intf_pins zed_audio_ctrl_0/S_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets fifo_generator_0_M_AXI] [get_bd_intf_pins fifo_generator_0/M_AXI] [get_bd_intf_pins system_ila_0/SLOT_5_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets fifo_generator_0_M_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports audio_i2c] [get_bd_intf_pins processing_system7_0/IIC_0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fifo_generator_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_6_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xfft_0_M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets xfft_0_M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net SDATA_I_0_1 [get_bd_ports SDATA_I_0] [get_bd_pins system_ila_0/probe0] [get_bd_pins zed_audio_ctrl_0/SDATA_I]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets SDATA_I_0_1]
  connect_bd_net -net fifo_generator_1_dout [get_bd_ports SDATA_O_0] [get_bd_pins fifo_generator_1/dout]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins fifo_generator_1/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins xfft_0/aclk] [get_bd_pins zed_audio_ctrl_0/S_AXI_ACLK]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn] [get_bd_pins xfft_0/aresetn] [get_bd_pins zed_audio_ctrl_0/S_AXI_ARESETN]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins fifo_generator_1/rd_en] [get_bd_pins fifo_generator_1/wr_en] [get_bd_pins xlconstant_2/dout]
  ...
  connect_bd_net -net zed_audio_ctrl_0_SDATA_O [get_bd_pins fifo_generator_1/din] [get_bd_pins zed_audio_ctrl_0/SDATA_O]
