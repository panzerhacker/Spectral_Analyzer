...
set_property -dict { PACKAGE_PIN U5   IOSTANDARD LVCMOS33 } [get_ports FCLK_CLK1_0]; 
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports BCLK_0]; 
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports LRCLK_0]; 
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports SDATA_O_0];
set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports SDATA_I_0]; 
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports {GPIO_AUDIO_tri_io[0]}]
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports {GPIO_AUDIO_tri_io[1]}]
